        ...
        if self.token_to_kv_pool_allocator is None:
            if _is_npu and (
                ...
                if self.is_hybrid_swa:
                    ...
                    # DCP port: when dcp_size > 1 the KV pool must use the
                    # widened-page paged allocator (else-branch below), so the
                    # plain page_size==1 fast path is gated on dcp_size == 1.
